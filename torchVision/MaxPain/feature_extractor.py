...
### Sequence length list doesn't work due to data formatting procedure
    param_vals = { 'batch_size':[100], 'shuffle': False,
                   ...
                   'num_workers':(4),'pin_memory':False,'non_blocking':True, 'device':(0)}#8
    
    
    model_type='OpticalFlow_ftex'##'SeqToTwo'## #['Conv','Vision','Scene','Optical','Spatiotemporal']
