    ...
    for p_tups in product(*param_vals.values()):
        ...
        for i in range(2,3):
           ...
           ##                   print(frame_name)
                              ...
                              elif 'OpticalFlow' in model_type:
                                  if not os.path.exists(frame_name[:-22]+'motion_feats'):
                                      os.mkdir(frame_name[:-22]+'motion_feats')
                                      
                                  frame_name = frame_name.replace('frames','motion_feats')
                                  #frame_name = frame_name[:-22]+'motion_feats'+'/op-00000001.jpg'
                                  print(frame_name)
